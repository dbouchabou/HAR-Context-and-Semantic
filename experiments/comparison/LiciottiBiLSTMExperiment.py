...
class LiciottiBiLSTMExperiment(Experiment):
    ...
    def encode_data(self):
        ...
        self.classifier_dataset_encoder.eventDict = tokenizer.word_index
    ...
    def prepare_data_for_classifier(self):
        ...
        #self.classifier_data_Y, self.classifier_dataset_encoder.actDict = self.rename_labels(aruba_dict)
